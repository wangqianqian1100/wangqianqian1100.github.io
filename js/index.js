$(function() {
	...
	w.load("<li class='writecode'>了解微信小程序开发，可独立完成页面及交互功能");
	w.load("<li class='writecode'>了解React框架，可独立完成页面及交互功能");
	w.load("</ul>");
	w.load("<h1 class='writecode'>项目</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'><a href='http://www.baidu.com' target='_blank'>www.baidu.com</a></li>");
	w.load("</ul>");
	c.load("<p><div class='comment writecode'>/**</div>");
